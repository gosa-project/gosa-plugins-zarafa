...
pburl gosa = svn+https://oss.gonicus.de/repositories/gosa/trunk/

# Repository
pbrepo gosa = http://apt.gosa-addons.org
#pbml gosa = gosa@oss.gonicus.de
...
#
sshhost fossology = apt.gosa-addons.org
sshlogin fossology = repo
sshdir fossology = /var/www/gosa-addons
...
#filteredfiles gosa = Makefile.PL,configure.in,install.sh,fossology.8
#supfiles gosa = fossology.init
...
#
# This project needs additional repository to be able to be built correctly
#
